...
UI = {
    "zh": {
        ...
        "credit_refusal": "⚠️ Minds 额度不足：AI 拒绝生成并提示需要充值。请到 build.hellominds.ai 充值或更换有额度的账号后重试。",
        "no_profile": "未选择人设",
        "mode_label": "当前模式",
        "download": "下载",
        "ws_label": "项目工作区",
    ...
    "en": {
        ...
        "credit_refusal": "⚠️ Minds credits exhausted: the AI refused to generate and asked for a top-up. Top up at build.hellominds.ai or switch to an account with credits, then retry.",
